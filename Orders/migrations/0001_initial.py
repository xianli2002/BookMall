# Generated by Django 4.0.5 on 2022-10-27 14:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Areas', '0002_alter_address_table_alter_area_table'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('Books', '0005_famousbooks'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Areas.address', verbose_name='收货地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Books.sku', verbose_name='订单商品')),
            ],
            options={
                'verbose_name': '订单商品',
